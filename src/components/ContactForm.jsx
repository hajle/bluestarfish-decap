...
const ContactForm = () => {
  ...
  const [btnText, setBtnText] = useState("Wyślij wiadomość");
  ...
  return (
    <>
      ...
      >
        {(statusMessage === 1 &&
          "Dziękujemy za kontakt! Wkrótce odpowiemy na Twoją wiadomość.") ||
          (statusMessage === 2 && "Błąd podczas wysyłania wiadomości.")}
      </p>
      {statusMessage === 0 || statusMessage === 2 ? (
        ...
        >
          ...
          <input
            ...
            placeholder="Imię"
          />
          <label className="mt-8 text-sm">Adres email</label>
          <input
            type="email"
            name="user_email"
            value={email}
            ...
            className="appearance-none border-[1px] border-gray-200 rounded bg-white px-2 py-2 focus:border-gray-400 focus:bg-gray-100 focus:outline-none transition"
          />
          <label className="mt-8 text-sm">Wiadomość</label>
          <textarea
            name="message"
            value={message}
